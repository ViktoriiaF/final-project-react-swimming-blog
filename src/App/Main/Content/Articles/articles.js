...
const articles=[
    {
        ...
        text:"Begin the catch phase with your elbow high, use your forearm to pull downwards. When your hand passes beneath your shoulder, your head should begin to rotate so that you can breathe properly.Continue the pull phase keeping your body in the right position and making sure your hand and arm are under your body and not alongside it. Try to catch as much water as possible with your forearm. Having completed the pull phase, the palm of your hand should be facing upwards. During the final push phase, your arm pushes backwards until it comes out of the water. During the recovery phase, raise your elbow and when your hand is halfway along your body rotate your head so that it is facing forwards again.  As soon as your hand reaches your shoulder, rotate it forwards so that it is just touching the water and extend it out in front of you to complete the stroke. ",
    ...
    },
    {
        ...
        text:"The underwater phase is considered to be a vital part of any swim stroke. What is the key to performing it properly? The first key to a perfect underwater phase is keeping your body perfectly streamlined under the surface of the water. Keep your head between your shoulders and your arms fully extended out in front.And then what?After pushing off, glide under the surface of the water for a few seconds and begin to move your hips and legs without bending your back excessively.The movement should begin from your hips and continue along your legs, coordinating your legs lift and kick. Make sure your upper body is fully extended in the right position.Your leg kick should initially be deep and powerful, gradually speeding up with quicker. shallower movements. Powerfin and Powerfin Pros are an excellent means of improving your underwater phase: they will help you control your body movement and allow you to feel the water better.",
    ...
    },
    {
        ...
        text:"<h1>WHICH GOGGLES SHOULD I CHOOSE FOR OUTDOOR SWIMMING?</h1><p>If you swim outdoors, particularly in open water, you should choose goggles with mirror lenses that reflect light and minimise the amount of light getting in your eyes.</p><ul>Mirror lenses for arena goggles come in various colours.<li>DARK LENSES: if the sun is extremely strong or bright, our advice is to choose dark-coloured mirror lenses, for example “blue” or “silver”, which will prevent any reverberation effect and keep the sun out of your eyes.</li><li>CLEAR LENSES: choose clear-coloured mirror lenses, for example a “copper” colour, for cloudy days when the sun is not so bright or when swimming early in the morning or late in the afternoon. The mirror effect is the same as with dark lenses, but the clear colour provides increased visibility in dim light.</li></ul>",
...
export const getArticlesObject = (array) => array.reduce((obj,product) => ({
    ...obj,
    [product.id]:product
}),{});
